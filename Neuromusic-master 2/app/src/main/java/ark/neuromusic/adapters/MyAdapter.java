...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
   ...
   public MyAdapter(String Titles[], int Icons[], String Name, String Email, String Profile, Context passedContext){ // MyAdapter Constructor with titles and icons parameter
